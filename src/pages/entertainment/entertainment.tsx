      ...
      <div className="e-main">
        ...
        <div className="e-suggest">
          <div className="e-heading">
            My Personal Suggestor
          </div>
          <div className="e-content">
            What you see below is a recommender engine that suggests you random movie, anime, or song...
            <Recommender />
          </div>
        </div>
        ...
        <div className="wall">
          ...
          <div className="e-content">These are some of my favourite wallpapers that I use often cause I think they are really cool XD
