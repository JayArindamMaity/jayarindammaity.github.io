      ...
      <div className="e-main">
        ...
        <div className="wall">
          ...
          <div className="wall-cont">These are some of my favourite wallpapers that I use often cause I think they are really cool XD
            <br /> Although I don't know the name of actual creators, cause I found them in random places... but these are really good quality ones and I hope you enjoy them... 
            <br />If you find their creator show them my gratitude as well 😊...
          </div>
